export class Type {
  ...
  isAssignableTo(other) {
    ...
    if (other instanceof UnknownType) return true; // Everything is assignable to unknown
...
export class LiteralType extends Type {
    ...
    isAssignableTo(other) {
        if (other instanceof AnyType || other instanceof UnknownType) return true;
        if (other instanceof LiteralType && this.value === other.value) return true;
        if (other instanceof UnionType) return other.types.some(t => this.isAssignableTo(t));
        
        const baseType = typeof this.value === 'string' ? Primitives.String :
                         typeof this.value === 'number' ? Primitives.Number :
                         typeof this.value === 'boolean' ? Primitives.Boolean : null;
        
        return baseType && baseType.isAssignableTo(other);
    }
}
